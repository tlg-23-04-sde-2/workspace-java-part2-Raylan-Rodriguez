...
public class Television implements Comparable<Television> {
    ...
    // Totally normal Java, i can see tuner and i can create and instance of it
    // ONlY I(Television) see it, and that is good, because only i need it.
    ...
    // outside this class, all client code will now say "Television.DisplayType".
    public enum DisplayType {
        LCD, LED, OLED, PLASMA, CRT
    }

    //outside this class all client code will now say "Television.BrandChannelComparator
    ...
    // outside this class all client code will now say Television.channelComparator
